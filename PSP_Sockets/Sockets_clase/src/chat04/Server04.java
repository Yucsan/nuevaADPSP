        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    if (mensajeCliente.equalsIgnoreCase("Cliente: N")) {
                    ...
                    System.out.println(ANSI_RED + "Cerrando Conexion... :::Conexión cerrada.");
                    break;
                }
            }

        } catch (IOException e1) {
            Logger.getLogger(Server04.class.getName()).log(Level.SEVERE, null, e1);
        } finally {
            try {
                if (socket != null) {
                	socket.close();                	
                ...
                System.out.println(ANSI_RED + "Conexión cerrada en finally");
            } catch (IOException e) {
                Logger.getLogger(Server04.class.getName()).log(Level.SEVERE, null, e);
            }
            tecTxt.close();
        }
    }
