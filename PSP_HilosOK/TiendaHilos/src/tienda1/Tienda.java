...
import tienda2.Cliente;
import tienda2.ItemProducto;
...
public class Tienda {
    ...
    private ReentrantLock cierreTienda; // Lock para sincronizar las compras
    ...
    public Tienda() {
        ...
        this.cierreTienda = new ReentrantLock(); // Inicializar el bloqueo
    }
